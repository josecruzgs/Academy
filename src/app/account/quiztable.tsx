...
function Quiztable() {
  return (
    ...
    <div className="w-full bg-gray-800 shadow-xl rounded-xl border border-gray-900">
    <header className="px-5 py-4 border-b border-gray-700 rounded-t-xl bg-gray-900 border-gray-100">
        <h2 className="font-semibold text-left text-gray-100">Quiz Results</h2>
    </header>
    <div className="p-3">
            ...
            <table className="table-auto w-full">
                ...
                <tbody className="text-sm divide-y divide-gray-100">
                    <tr>
                        ...
                        <td className="p-2 whitespace-nowrap">
                            <div className="text-left text-gray-400">Knoledge basic of Blockchain</div>
                        </td>
                        <td className="p-2 whitespace-nowrap">
