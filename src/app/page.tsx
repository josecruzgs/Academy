    ...
    <>
      <div className="antialiased  pt-10 relative bg-lines mt-10 lg:mt-1 ">
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-5 text-gray-300">Where Innovation Meets</h1>
          <p className="text-5xl md:text-6xl font-bold mb-5  bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.indigo.400),theme(colors.indigo.100),theme(colors.sky.400),theme(colors.fuchsia.400),theme(colors.sky.400),theme(colors.indigo.100),theme(colors.indigo.400))] bg-[length:200%_auto] animate-gradient">Web 3.0 Education</p>
          <p className="mb-8 text-white text-lg font-normal  lg:text-xl sm:px-16 xl:px-48 ">In our academy, we are not only teaching about cryptocurrencies and blockchain but also contributing to building a more inclusive and equitable future through technology. We invite you to join this mission.</p>
